...
export function Filters(props: PropsWithChildren<FiltersProps>): JSX.Element {
    ...
    const setUnusedOnlyFilter = useCallback((e) => setFilter("UNUSED_ONLY", e.target.checked), [setFilter]);
    const setUsedOnlyFilter = useCallback((e) => setFilter("USED_ONLY", e.target.checked), [setFilter]);
