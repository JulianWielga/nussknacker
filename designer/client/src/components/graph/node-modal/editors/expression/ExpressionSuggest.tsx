...
function ExpressionSuggest(props: Props): JSX.Element {
    ...
    useEffect(
        () => customAceEditorCompleter.replaceSuggester(expressionSuggester),
        [customAceEditorCompleter, expressionSuggester]
    );
    ...
    return dataResolved ? (
        <>
            ...
            {showValidation && (
                <ValidationLabels validators={validators} values={[value]} validationLabelInfo={validationLabelInfo} />
            )}
        </>
    ) : null;
}
