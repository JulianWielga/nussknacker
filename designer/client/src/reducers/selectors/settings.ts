...
export const getAuthenticationSettings = createSelector(
    getSettings,
    (s): AuthenticationSettings => s.authenticationSettings
);
...
export const getTargetEnvironmentId = createSelector(
    getFeatureSettings,
    (s) => s?.remoteEnvironment?.targetEnvironmentId
);
...
export const getMetricsSettings = createSelector(
    getFeatureSettings,
    (settings) => settings?.metrics || ({} as MetricsType)
);
