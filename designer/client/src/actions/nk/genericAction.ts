...
export type NodeValidationUpdated = {
    type: "GENERIC_ACTION_VALIDATION_UPDATED";
    validationData: GenericValidationData;
};
...
const validate = debounce(
    async (
        processId: string,
        validationRequestData: GenericValidationRequest,
...
export function validateGenericActionParameters(
    processId: string,
    validationRequestData: GenericValidationRequest
): ThunkAction {
    return (dispatch) =>
