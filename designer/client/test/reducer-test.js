...
describe("Nodes added", () => {
    ...
    it("should add nodes with edges", () => {
        ...
        expect(NodeUtils.getNodeById("newNode", result.graphReducer.processToDisplay)).toEqual({
            ...testNode,
            id: "newNode",
        });
        expect(NodeUtils.getNodeById("kafka-transaction (copy 1)", result.graphReducer.processToDisplay)).toEqual({
        ...
        expect(
            NodeUtils.getEdgeById("newNode-kafka-transaction (copy 1)", result.graphReducer.processToDisplay)
        ).toEqual({
            from: "newNode",
