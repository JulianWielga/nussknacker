...
describe("CountsRangesButtons tests", () => {
    ...
    it("should collapse buttons", () => {
        ...
        const wrapper = mount(<CountsRangesButtons ranges={ranges} onChange={changeFn} limit={1} />, {
            attachTo: root,
        });
    ...
    it("should hide expand button when not needed", () => {
        const wrapper = mount(<CountsRangesButtons ranges={ranges} onChange={changeFn} limit={10} />);
